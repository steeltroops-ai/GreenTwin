    ...
    <div className="min-h-screen bg-background">
        ...
        <div className="mx-auto max-w-7xl px-6 py-4 flex items-center gap-4">
          ...
          <div className="hidden sm:flex items-center gap-3">
            ...
            <Badge variant="secondary" className="rounded-full">
              Live grid: {grid} gCO₂/kWh
            </Badge>
            <Switch checked={dark} onCheckedChange={setDark} />
          </div>
          <Button className="ml-2" onClick={share} variant="secondary">
      ...
      <main className="mx-auto max-w-7xl px-6 pb-24 pt-8">
        <section className="grid gap-6 md:grid-cols-3">
          <Card className="md:col-span-2 overflow-hidden">
            <CardHeader className="pb-2">
              <CardTitle className="flex items-center gap-2">
                <Sparkles className="size-5" /> Digital Carbon Twin
              </CardTitle>
              <CardDescription>
                Passive tracking + predictive nudges. Your baseline, forecast,
          ...
          <Card>
            <CardHeader className="pb-2">
              <CardTitle className="flex items-center gap-2">
                <Bolt className="size-5" /> Grid‑aware Nudges
              </CardTitle>
              <CardDescription>
            ...
            <CardContent className="space-y-4">
              ...
              <ul className="text-sm space-y-2 list-disc pl-5">
                ...
                <li>
                  Pre‑cool home at {cleanWindow.split("-")[0]} to reduce peak
                  load
                </li>
              </ul>
              <Button className="w-full">
                <Target className="mr-2 size-4" /> Auto‑schedule my tasks
              </Button>
            </CardContent>
          </Card>
        </section>
        ...
        <section className="mt-6 grid gap-6 md:grid-cols-3">
          <Card className="md:col-span-2 h-full">
            <CardHeader className="pb-2">
              ...
              <CardDescription>
                Ask for product footprints, climate myth‑busting, or best swaps
                with savings.
              </CardDescription>
            </CardHeader>
            <CardContent className="flex flex-col h-[420px]">
              <div className="flex-1 overflow-y-auto rounded border p-3 space-y-3 bg-background/50">
                {messages.map((m, i) => (
                  <div
                    key={i}
                    className={`max-w-[85%] rounded-lg px-3 py-2 text-sm ${m.role === "assistant" ? "bg-secondary" : "bg-primary text-primary-foreground ml-auto"}`}
                  >
                    {m.text}
                  </div>
                ))}
              ...
              <div className="mt-3 flex items-center gap-2">
                ...
                <Button onClick={send} className="shrink-0">
                  Send <ArrowRight className="ml-2 size-4" />
                </Button>
              </div>
          ...
          <Card>
            <CardHeader className="pb-2">
              ...
              <CardDescription>
                Personalized ROI from your swaps
              </CardDescription>
            </CardHeader>
        ...
        <section className="mt-6 grid gap-6 md:grid-cols-3">
          <Card>
            ...
            <CardContent className="space-y-3">
              ...
              />
              <Button className="w-full" onClick={checkClaim}>
                Check claim
              </Button>
              {claimVerdict !== null && (
                <div className="text-sm">
                  ...
                  <Badge
                    variant={
                      claimVerdict.includes("Supported")
                        ? "secondary"
                        : claimVerdict.includes("False")
                          ? "destructive"
                          : "outline"
                    }
                  >
                  ...
                  <p className="mt-2 text-muted-foreground">
                    Source hint: IPCC AR6, IEA fact sheets (stubbed).
                  </p>
                </div>
              )}
            </CardContent>
          ...
          <Card>
            ...
            <CardContent className="space-y-3">
              ...
              {lastSwapMsg && (
                <p className="text-xs text-muted-foreground">{lastSwapMsg}</p>
              )}
            </CardContent>
          </Card>
      ...
      <footer className="border-t">
        <div className="mx-auto max-w-7xl px-6 py-8 flex flex-col sm:flex-row items-center justify-between gap-4">
          <p className="text-sm text-muted-foreground">
            © {new Date().getFullYear()} Green Twin. Built for hackathons,
            ready for scale.
          </p>
          <div className="flex items-center gap-2">
